...
our $SCHEMA = [
    ...
    {item => ['rofi -show run -modi wun', 'Run command',  'system-run']},
    ...
    {item => ['flameshot full -c', 'Take Screenshot']},
    {item => ['flameshot gui',     'Take Screenshot (Area)']},

    {sep => undef},

    ## The xscreensaver lock command
    {item => ['light-lock-command -l', 'Lock', 'system-lock-screen']},
